...
import 'package:coffee_shop/credenials/login.dart';
...
class _CoffeeAppState extends State<CoffeeApp> with TickerProviderStateMixin {
  ...
  String appBarTitle = "Menu Principal";
    ...
    return MaterialApp(
      ...
      home: Scaffold(
        ...
        appBar: AppBar(
          ...
          leadingWidth: 65,
          elevation: 0,
          title: Text(this.appBarTitle, style: TextStyle(color: Colors.black54, fontSize: 20)),
          centerTitle: true,
          leading: IconButton(
                ...
                children: [
                  ...
                  TextScroll(
                    ...
                    builder: (BuildContext context, int index) {
                      final priceFormat = "\Kz${prices[index]}";
          ...
          child: Opacity(
            ...
            child: SizedBox(
              ...
              child: FloatingActionButton(
                onPressed: () {// Set a default or current selected product
                  DialogHelper.showToast("Hamburger created");
                },
                          ...
                          child: Transform.translate(
                            ...
                            child: ImageItem(
                              ...
                              onClick: (Offset? offset) {
                                ...
                                setState(() {
                                  appBarTitle = "Detalhes do hamburguer";
